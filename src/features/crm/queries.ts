...
import { getCrmTree, listCrmPeople, listOpportunities } from "./service";
import type { CrmPerson, Opportunity } from "./summary";
import { findFunnel, type CrmFunnel, type CrmTreeNode } from "./tree";
...
export async function loadCrmScreenData(query: CrmQuery, slug?: string, next = "/crm"): Promise<CrmScreenData> {
  ...
  return { opportunities, team, tree, funnel };
}
