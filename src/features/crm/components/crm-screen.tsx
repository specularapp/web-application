...
export function CrmScreen({ board, query, collapsed, ai, title, basePath, team }: CrmScreenProps) {
  return (
    <div className={styles.screen}>
      <Topbar ai={ai} title={title} />
      <CrmBoard board={board} query={query} collapsed={collapsed} basePath={basePath} team={team} />
    </div>
  );
}
