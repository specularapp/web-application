...
// sobre a lista.
export function QuotesScreen({ page, query, ai, editing, prefill, clients, catalog, issuer, owner, nextNumber }: QuotesScreenProps) {
  return (
    <div className={styles.screen}>
      <Topbar ai={ai} />
      <QuotesBoard page={page} query={query} editing={editing} prefill={prefill} clients={clients} catalog={catalog} issuer={issuer} owner={owner} nextNumber={nextNumber} />
    </div>
  );
}
