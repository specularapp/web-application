...
- Alerta de plano no formato da referência: identidade em cima (ícone tingido, "plano atual" e o nome do plano), frase curta no meio e botão cheio embaixo. Fundo e borda saem de `color-mix` sobre `--color-accent` (8% e 24%), e não de cinza: o cartão puxa o olho sem virar caixa de aviso, e funciona nos dois temas porque a mistura é com o próprio fundo.
