...
- Cabeçalho enxuto: o título, a etiqueta do plano que libera a operação (criar equipe é do Alliance) e o X na outra ponta. O rótulo curto do plano saiu do `AppShell` e virou `planBadges` em `billing/plans.ts`, porque agora dois lugares o usam.
