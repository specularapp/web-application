...
- A capa é de perfil de rede social: banner deitado em cima e a bola da logo montada sobre ele, presa na esquerda, com metade dela para fora da borda de baixo. O par é montado pelo `ImageGroup`, exportado junto do `ImagePicker`, então a gaveta e os primeiros passos usam o mesmo agrupador.
...
- O divisor que abre as pessoas corre de ponta a ponta, sangrando o recuo da coluna pelos dois lados, então elas nascem como bloco novo em vez de mais um campo. Depois dele vêm o título "Membros", os campos de convite com o botão e, por último, a lista de quem já está, com quem cria no topo.
