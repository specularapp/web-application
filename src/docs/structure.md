...
- A capa é de perfil de rede social: banner deitado em cima e a bola da logo montada sobre ele, presa na esquerda, com três quartos dela dentro do banner e só um quarto para fora. O par é montado pelo `ImageGroup`, exportado junto do `ImagePicker`, então a gaveta e os primeiros passos usam o mesmo agrupador.
