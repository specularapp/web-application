...
De cima para baixo, seguindo a referência do usuário (a barra de projeto da Vercel): o time no lugar da marca, com logo de 24px, nome e a seta dupla, e nada mais; campo de busca com a tecla de atalho; rotas em grupos separados por linha; e, colado no fim, o convite de ação, a meta e o perfil. A marca saiu do menu de propósito: quem identifica o contexto ali é o time, não o produto.
