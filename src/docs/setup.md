...
5. O logo dos e-mails é só o ícone: `public/logotipo/specular-icon-black.png` (gerado do SVG; e-mail não renderiza SVG), servido em `https://app.specular.com.br/logotipo/...`. Publicar antes de testar o e-mail em produção.
